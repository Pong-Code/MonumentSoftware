...
public class InsertMonuments extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int id = Mysql.insertMonument(title,desc, country, estado, year, loc.getLatitude(), loc.getLongitude(), owner);
        if(id != -1){
            //Atualiza a lista dos monumentos
            Monuments monument = new Monuments();
            monument.addmonument(id, title, year, desc, country, loc.getLatitude(), loc.getLongitude(), owner, estado);
            //Atualiza a lista dos marcadores
            MarkersAPI marker = new MarkersAPI(loc, id);
            marker.addMarker(loc, id);
